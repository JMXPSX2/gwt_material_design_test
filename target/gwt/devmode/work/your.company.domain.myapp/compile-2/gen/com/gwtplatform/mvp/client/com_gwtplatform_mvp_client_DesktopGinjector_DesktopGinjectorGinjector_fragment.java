...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
   ...
   *   your.company.domain.client.gin.ClientModule.configure(ClientModule.java:37)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   your.company.domain.client.gin.ClientModule.configure(ClientModule.java:38)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   your.company.domain.client.gin.ClientModule.configure(ClientModule.java:39)
   */
