// .ui.xml template last modified: 1676960779615
...
public class HomeView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, your.company.domain.client.application.home.HomeView>, your.company.domain.client.application.home.HomeView.Binder {


  public com.google.gwt.user.client.ui.Widget createAndBindUi(final your.company.domain.client.application.home.HomeView owner) {
   ...
   */
  class Widgets {
    private final your.company.domain.client.application.home.HomeView owner;


    public Widgets(final your.company.domain.client.application.home.HomeView owner) {
      this.owner = owner;
    }
     ...
     */
    private your.company.domain.client.application.home.HomeView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private your.company.domain.client.application.home.HomeView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final your.company.domain.client.application.home.HomeView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (your.company.domain.client.application.home.HomeView_BinderImpl_GenBundle) GWT.create(your.company.domain.client.application.home.HomeView_BinderImpl_GenBundle.class);
      // Setup section.
    ...
    private gwt.material.design.client.ui.MaterialLabel build_f_MaterialLabel5() {
      ...
      f_MaterialLabel5.setText("Welcome to gwt-material World");
    ...
    private gwt.material.design.client.ui.MaterialLabel build_f_MaterialLabel6() {
      ...
      // Setup section.
      f_MaterialLabel6.setText("Version 2.4.0");
