// .ui.xml template last modified: 1676960779603
...
public class ApplicationView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, your.company.domain.client.application.ApplicationView>, your.company.domain.client.application.ApplicationView.Binder {
  ...
  class Widgets {
    ...
    private gwt.material.design.client.ui.MaterialPanel build_f_MaterialPanel1() {
      ...
      f_MaterialPanel1.add(get_f_MaterialFAB11());
    ...
    /**
     * Getter for f_MaterialFAB11 called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private gwt.material.design.client.ui.MaterialFAB get_f_MaterialFAB11() {
      return build_f_MaterialFAB11();
    }
    private gwt.material.design.client.ui.MaterialFAB build_f_MaterialFAB11() {
      // Creation section.
      final gwt.material.design.client.ui.MaterialFAB f_MaterialFAB11 = (gwt.material.design.client.ui.MaterialFAB) GWT.create(gwt.material.design.client.ui.MaterialFAB.class);
      // Setup section.
      f_MaterialFAB11.add(get_btnAdd());

      return f_MaterialFAB11;
    }
