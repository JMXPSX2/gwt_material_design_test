...
public class MaterialSubHeaderClientBundle_default_InlineClientBundleGenerator implements gwt.material.design.addins.client.subheader.MaterialSubHeaderClientBundle {
  ...
  private void subheaderCssInitializer() {
    subheaderCss = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/Users/jmxpsx/.m2/repository/com/github/gwtmaterialdesign/gwt-material-addins/2.4.0/gwt-material-addins-2.4.0.jar!/gwt/material/design/addins/client/subheader/resources/css/subheader.min.css
  ...
  private void subheaderDarkCssInitializer() {
    subheaderDarkCss = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/Users/jmxpsx/.m2/repository/com/github/gwtmaterialdesign/gwt-material-addins/2.4.0/gwt-material-addins-2.4.0.jar!/gwt/material/design/addins/client/subheader/resources/css/subheader-dark.min.css
      public String getText() {
        return ".subheader,.subheader-static{background-color:#2f2f2f}";
      }
      public String getName() {
  ...
  private void subheaderJsInitializer() {
    subheaderJs = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/Users/jmxpsx/.m2/repository/com/github/gwtmaterialdesign/gwt-material-addins/2.4.0/gwt-material-addins-2.4.0.jar!/gwt/material/design/addins/client/subheader/resources/js/subheader.min.js
      public String getText() {
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'subheaderDarkCss': return this.@gwt.material.design.addins.client.subheader.MaterialSubHeaderClientBundle::subheaderDarkCss()();
